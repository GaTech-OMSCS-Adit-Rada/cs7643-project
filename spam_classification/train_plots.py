...
import torch
from spam_classification.train import TrainingConfig, TrainingResults
...
def plot_accuracies(training_config: TrainingConfig, training_results: TrainingResults, filepath=None):
    """Plots training and validation accuracies against epochs and tokens seen."""
    print("Plotting accuracies...")
    _plot_metric_vs_epochs(
        training_config=training_config,
        # Using track_tokens_seen as in the original function
        tokens_seen=training_results.track_tokens_seen,
        train_data=training_results.train_accuracies,
        val_data=training_results.val_accuracies,
